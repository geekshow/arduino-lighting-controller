/*
  ...
  - tidy up
  - RTOS?
  - Move to arrays and loops for inputs/outputs?
*/
...
#define MQTT_TOPIC_OUT "controller01"
#define MQTT_TOPIC_IN "controller01/command/#"
#define MQTT_TOPIC_OUTPUT "controller01/command/output"
...
byte mac[]    = {  0x00, 0x00, 0x00, 0xBE, 0xEF, 0x01 };
...
void publishStatus() {
  ...
  mqttPublishString("status/temperature0",String(t0));
  mqttPublishString("status/humidity0", String(h0));
  mqttPublishString("status/temperature1",String(t1));
  mqttPublishString("status/humidity1", String(h1));
